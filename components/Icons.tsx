...
export const HeartIcon: React.FC<IconProps> = ({ className, size = 24, onClick }) => (
  <svg 
...
export const XIcon: React.FC<IconProps> = ({ className, size = 24, onClick }) => (
...
export const TrashIcon: React.FC<IconProps> = ({ className, size = 24, onClick }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} onClick={onClick}>
